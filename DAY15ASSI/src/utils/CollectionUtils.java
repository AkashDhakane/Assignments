...
//add static method for populating map with sample data
	public static HashMap<String,Book> populateMap() {
		...
		map.put("BIOLOGY", new Book("BIOLOGY",Category.ADVENTURE, 5000, LocalDate.parse("2000-04-21"), "ABC", 5));
		map.put("OOPS",new Book("OOPS",Category.FANTASY, 5000, LocalDate.parse("2021-03-21"), "CD", 2));
		map.put("PANCHTANTRA", new Book("PANCHTANTRA",Category.ADVENTURE, 5000, LocalDate.parse("2000-04-21"), "ABC", 5));
		map.put("RICH DAD POOR DAD",new Book("RICH DAD POOR DAD",Category.FANTASY, 5000, LocalDate.parse("2021-03-21"), "CD", 2));
